...
public class ExplorerPart {
	...
	public void createPartControl(final Composite parent, MPart mpart) {
		...
		getTreeViewer().setUseHashlookup(false);
	...
	/**
	 * the message will be broadcasted to viewer filter and label provider after
	...
	/**
     * After user select a type of tree entity on drop down box, all entities will be
     * filtered by all elements by selection type and searched string
     */
	...
	/**
     * After user type a text on searched text box, all entities will be
     * filtered by all elements by the text
     */
