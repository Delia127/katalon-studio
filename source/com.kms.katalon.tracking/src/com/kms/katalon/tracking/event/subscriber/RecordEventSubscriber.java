...
public class RecordEventSubscriber extends AbstractTrackingEventSubscriber {

    @Override
    protected boolean accept(TrackingEvent event) {
         return event.getTrigger() == UsageActionTrigger.RECORD;
    }
    ...
    protected ISentEventInfo getSentEventInfo() {
        ...
        return new ISentEventInfo() {
            ...
            public JsonObject getPropertiesObject() {
                ...
                properties.addProperty("action", "record");
