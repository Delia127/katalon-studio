...
public class TestSuiteCollectionExecutionEventSubscriber extends AbstractTrackingEventSubscriber {

    @Override
    protected boolean accept(TrackingEvent event) {
        return event.getTrigger() == UsageActionTrigger.EXECUTE_TEST_SUITE_COLLECTION;
    }
    @Override
    protected ISentEventInfo getSentEventInfo() {
        ...
        return new ISentEventInfo() {
            ...
            public JsonObject getPropertiesObject() {
                ...
                properties.addProperty("object", "Test Suite Collection");
