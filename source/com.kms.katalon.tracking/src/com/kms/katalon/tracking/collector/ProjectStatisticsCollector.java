package com.kms.katalon.tracking.collector;
...
public class ProjectStatisticsCollector {
    ...
    public ProjectStatisticsCollector(ProjectEntity project) {
        this.project = project;
    }
    
    public ProjectStatistics collect() throws Exception {
        ...
        countTestSuitesAndTestCasesInTestSuites();
    ...
    public void countTestCases() throws Exception {
    ...
    public void countTestSteps() throws IOException {
    ...
    public void countTestObjects() throws Exception {
    ...
    public void countTestSuitesAndTestCasesInTestSuites() throws Exception {
    ...
    public void countTestData() throws Exception {
    ...
    public void countCheckpoints() throws Exception {
    ...
    public void countCustomKeywords() throws Exception {
    ...
    public void countTestListeners() throws Exception {
    ...
    public void countReportsAndTestExecutions() throws Exception {
...
//        int reportCount = executionPropertiesFiles.length;
    ...
    public void countProfiles() throws DALException {
    ...
    public boolean isJiraIntegrated() throws IOException {
    ...
    public boolean isRemoteWebDriverConfigured() throws IOException {
