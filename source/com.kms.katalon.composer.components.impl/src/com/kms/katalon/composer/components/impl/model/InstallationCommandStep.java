...
public class InstallationCommandStep extends InstallationStep {
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        try {
            ...
            if (runCommand(commands, getEnvs(), workingDirectory, getLogFile(), getErrorLogFile()) != 0) {
                throw new RunInstallationStepException("Failed to run the installation command.",
                        new Throwable(String.format("Command: \"%s\"", command)));
            }
    ...
    private int runCommand(String[] commands, Map<String, String> envs, String workingDirectory, File logFile,
            File errorLogFile) throws IOException, InterruptedException {
