...
public class CMultipleSelectionDropdownBox extends Composite {
    private Shell popup;
    ...
    private List<Integer> selectionIndices = new ArrayList<>();

    public CMultipleSelectionDropdownBox(Composite parent, int style) {
        super(parent, style);
        // create label
...
//        selectedLabel.setImage(imageLabel);
        ...
        listener = new Listener() {
            public void handleEvent(Event event) {
                ...
                if (CMultipleSelectionDropdownBox.this == event.widget) {
                    comboEvent(event);
                }
            }
        };
...
//                        selectedLabel.setText("Select items");
//                    } else {
...
//        });
    ...
    public void setSelectionIndices(int[] selectionIndices) {
        this.selectionIndices = Arrays.stream(selectionIndices).boxed().collect(Collectors.toList());
    }
    
    public int[] getSelectionIndices() {
        return selectionIndices.stream().mapToInt(i -> i).toArray();
    }
}
