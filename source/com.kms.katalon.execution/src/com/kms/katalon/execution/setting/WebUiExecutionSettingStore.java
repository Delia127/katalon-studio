...
import com.kms.katalon.execution.constants.WebUiExecutionSettingConstants;
...
public class WebUiExecutionSettingStore extends BundleSettingStore {
    ...
    public WebUiExecutionSettingStore(ProjectEntity projectEntity) {
        super(projectEntity.getFolderLocation(), IdConstants.KATALON_WEB_UI_EXECUTION_ID, false);
    }
