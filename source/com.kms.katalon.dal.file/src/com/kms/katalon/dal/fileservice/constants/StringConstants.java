...
public class StringConstants extends GlobalStringConstants {
    ...
    // CheckpointFileServiceManager
    public static final String MNG_EXC_CHECKPOINT_IS_NULL = "Checkpoint is null.";

    public static final String MNG_EXC_PROJECT_IS_NULL = "Project is null.";

    public static final String MNG_EXC_PARENT_FOLDER_IS_NULL = "Parent Folder is null.";
