...
public class DragAndDropKeyword extends MobileAbstractKeyword {
    ...
    public void dragAndDrop(TestObject fromObject, TestObject toObject, int timeout, FailureHandling flowControl) throws StepFailedException {
        ...
        }, flowControl, (fromObject != null && toObject != null) ? MessageFormat.format(StringConstants.KW_MSG_FAILED_TO_DRAG_AND_DROP_ELEMENT_X_TO_ELEMENT_Y, [fromObject.getObjectId(), toObject.getObjectId()] as Object[]) : StringConstants.KW_MSG_FAILED_TO_DRAG_AND_DROP_ELEMENT)
    }
}
