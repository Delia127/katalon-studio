...
import com.kms.katalon.composer.testcase.treetable.AstSwitchDefaultStatementTreeTableNode;
...
public class TestCaseTreeTableInput {
	...
	public void removeRow(AstTreeTableNode treeTableNode) throws Exception {
		if (treeTableNode instanceof AstElseStatementTreeTableNode
			...
			((TryCatchStatement) treeTableNode.getParentASTObject()).getCatchStatements().remove(
