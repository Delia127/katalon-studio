...
public class TestObjectSelectionDialog extends TreeEntitySelectionDialog {
 private List<Object> checkedItems;
    
    public TestObjectSelectionDialog(
            Shell parent,
    ...
    public WebElementTreeEntity[] getSelectedTestObjects() throws Exception {
        List<WebElementTreeEntity> selectedTreeEntities = flattenDialogResult(getResult());
        return selectedTreeEntities.toArray(new WebElementTreeEntity[selectedTreeEntities.size()]);
    }

    private List<WebElementTreeEntity> flattenDialogResult(Object[] dialogResult) throws Exception {
        if (dialogResult == null) {
            return Collections.emptyList();
        }
        List<WebElementTreeEntity> selectedTreeEntities = new ArrayList<>();
        for (Object eachResult : dialogResult) {
            if (eachResult instanceof WebElementTreeEntity) {
                selectedTreeEntities.add((WebElementTreeEntity) eachResult);
