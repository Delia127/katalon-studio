...
public class TestCaseSelectionDialog extends TreeEntitySelectionDialog {
    ...
    public TestCaseSelectionDialog(
            Shell parent,
    ...
    public TestCaseTreeEntity[] getSelectedTestCases() throws Exception {
        List<TestCaseTreeEntity> selectedTreeEntities = flattenDialogResult(getResult());
        return selectedTreeEntities.toArray(new TestCaseTreeEntity[selectedTreeEntities.size()]);
    }

    private List<TestCaseTreeEntity> flattenDialogResult(Object[] dialogResult) throws Exception {
        if (dialogResult == null) {
            return Collections.emptyList();
        }
        List<TestCaseTreeEntity> selectedTreeEntities = new ArrayList<>();
