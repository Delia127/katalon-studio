...
public class KeywordContentProposalAdapter {
     ...
     * explicit invocation keyStroke was specified. If this parameter is <code>null</code>, then only a specified
     * keyStroke will invoke
     ...
     * keyStroke will invoke content proposal. If this parameter is <code>null</code> and the keyStroke value is
     ...
     * control's content. Should be one of <code>PROPOSAL_INSERT</code>, <code>PROPOSAL_REPLACE</code>, or
     ...
     * filtering of the proposals shown. <code>FILTER_NONE</code> specifies that no filtering will occur in the content
     * proposal
     ...
     * typed since the popup has been open. The default is <code>FILTER_NONE</code>.
     */
     ...
     * popup affect filtering of the proposals shown. <code>FILTER_NONE</code> specifies that no automatic
    ...
    public Shell getPopupShell() {
        return popup != null ? popup.getShell() : null;
    }
