...
public class WindowsRecordedStepsView implements ITestCasePart {
    ...
    private RecordedWindowsElementTableViewer capturedElementsTableViewer;

    public CTreeViewer getTreeTable() {
        return treeViewer;
    }

    public WindowsRecordedStepsView() {
    ...
    public Composite createContent(Composite parent) {
        ...
        addTreeTableColumn(treeViewer, treeColumnLayout, StringConstants.PA_COL_OBJ, 120, 0, new AstTreeLabelProvider(),
                new CapturedWindowsElementEdittingSupport(treeViewer, this));
    ...
    public void addSimpleKeyword(String keywordName, boolean hasParam) {
        String webUiKwAliasName = WindowsActionUtil.getWindowsKeywordClass().getAliasName();
    ...
    public void clearSteps() throws InvocationTargetException, InterruptedException {
        treeTableInput.clearRows();
        treeTableInput.reloadTreeTableNodes();
    }
    ...
    public RecordedWindowsElementTableViewer getCapturedElementsTableViewer() {
        return capturedElementsTableViewer;
    }

    public void setCapturedElementsTableViewer(RecordedWindowsElementTableViewer capturedElementsTableViewer) {
