...
public class NewWindowsElementPropertyDialog extends AbstractDialog {
    
    private WebElementPropertyEntity newProperty;

    private Text txtName;

    private Text txtValue;

    public NewWindowsElementPropertyDialog(Shell parentShell) {
        super(parentShell);
    }
    ...
    protected void okPressed() {
        newProperty = new WebElementPropertyEntity(txtName.getText(), txtValue.getText());
        super.okPressed();
    }
    ...
    public WebElementPropertyEntity getNewProperty() {
        return newProperty;
    }
}
