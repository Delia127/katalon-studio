...
public class GroovyParser {
	...
	public void parseType(ClassNode classNode) {
		...
		if (name.startsWith("[")) {
			/*
			 * int numDimensions = 0; while (name.charAt(numDimensions) == '[')
			 * { numDimensions++; } StringBuilder stringBuilder = new
			 * StringBuilder();
			 * stringBuilder.append(classNode.getTypeClass().getComponentType()
			 * == null ? classNode.getTypeClass() .getComponentType().getSim :
			 * Object.class.getName()); for (int i = 0; i < numDimensions; i++)
