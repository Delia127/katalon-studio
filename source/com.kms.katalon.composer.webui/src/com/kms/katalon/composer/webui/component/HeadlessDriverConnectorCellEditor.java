...
public class HeadlessDriverConnectorCellEditor extends DriverConnectorCellEditor {
    public HeadlessDriverConnectorCellEditor(Composite parent) {
        super(parent);
        setValidator(new ICellEditorValidator() {

            @Override
            public String isValid(Object value) {
                if (value instanceof HeadlessDriverConnector) {
                    return null;
                }
    ...
    protected DriverConnectorBuilderDialog getDriverConnectorBuilderDialog() {
        return new WebUiDriverConnectorBuilderDialog(Display.getCurrent().getActiveShell(),
                (HeadlessDriverConnector) getValue());
    }
