...
public class AnalyticsApiProvider {
    ...
    public static List<AnalyticsTeam> getTeams(String serverUrl, String accessToken)
            throws AnalyticsApiExeception {
        try {
    ...
    public static AnalyticsProject createProject(String serverUrl, String projectName, AnalyticsTeam team, String accessToken) 
            throws AnalyticsApiExeception{
        try {
            URI uri = getApiURI(serverUrl, AnalyticsStringConstants.ANALYTICS_API_PROJECTS);
            HttpClient httpClient = HttpClientBuilder.create().build();
    ...
    public static void sendLog(String serverUrl, 
                                long projectId, 
                                long timestamp, 
                                String folderName, 
                                File file, 
                                boolean isEnd,
                                String token) throws AnalyticsApiExeception {
        try {
    ...
    public static void uploadFileInfo(
            String serverUrl,
            long projectId,
            long timestamp,
            String folderName,
