...
public class ImportOpenApiDialog extends CustomTitleAreaDialog {

    private String directory = "";

    public ImportOpenApiDialog(Shell parentShell) {
        super(parentShell);
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText(StringConstants.VIEW_DIA_TITLE_WEBSERVICE_REQ_OPENAPI3);
    }

    @Override
    protected Composite createContentArea(Composite parent) {

        setDialogTitle(StringConstants.VIEW_DIA_TITLE_WEBSERVICE_REQ_OPENAPI3);
        setMessage(StringConstants.DIA_MSG_IMPORT_WEBSERVICE_REQ_OPENAPI3, IMessageProvider.INFORMATION);
        ...
        messageLabel.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                Program.launch("https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.2.md");
            }
        });
        return composite;
    }
