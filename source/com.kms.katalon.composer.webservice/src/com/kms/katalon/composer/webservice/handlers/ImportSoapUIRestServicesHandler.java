...
import com.kms.katalon.composer.webservice.view.ImportSoapUIRestServicesDialog;
...
public class ImportSoapUIRestServicesHandler {
    ...
    public void execute(@Named(IServiceConstants.ACTIVE_SELECTION) @Optional Object[] selectedObjects,
        ...
        try {
            ...
            ImportSoapUIRestServicesDialog dialog = new ImportSoapUIRestServicesDialog(parentShell, parentFolderEntity);
            dialog.open();
        } catch (Exception e) {
