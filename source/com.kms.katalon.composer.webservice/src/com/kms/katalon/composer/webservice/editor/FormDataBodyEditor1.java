...
import com.kms.katalon.composer.components.impl.editors.FileSelectionCellEditor;
...
public class FormDataBodyEditor1 extends AbstractFormBodyEditor<FormDataBodyParameter> {
    ...
    public FormDataBodyEditor1(Composite parent, int style) {
        super(parent, style);
    }
    ...
    protected ParameterTable doCreateParameterTable(Composite parent) {
        ...
        cvValue.setEditingSupport(new EditingSupport(cvValue.getViewer()) {
            ...
            protected void setValue(Object element, Object value) {
//                FormDataBodyParameter param = (FormDataBodyParameter) element;
//                if (param.getType().equals(FormDataBodyParameter.PARAM_TYPE_FILE)) {
