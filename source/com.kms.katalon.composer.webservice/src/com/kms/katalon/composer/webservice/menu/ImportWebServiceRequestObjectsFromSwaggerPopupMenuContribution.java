...
public class ImportWebServiceRequestObjectsFromSwaggerPopupMenuContribution {
	private static final String WEBSERVICE_REQ_SWAGGER_POPUP_MENUITEM_LABEL = StringConstants.MENU_CONTEXT_WEBSERVICE_REQ_SWAGGER;
	private static final String NEW_WEBSERVICE_REQ_SWAGGER_COMMAND_ID = "com.kms.katalon.composer.webservice.command.swagger";
