...
/**
 * This class copied all the codes of {@link FieldEditorPreferencePage} to extend {@link PreferencePageWithHelp}
 * because the original class contains private fields.
 * This class should not be re-factored.
 */
public abstract class FieldEditorPreferencePageWithHelp extends PreferencePageWithHelp
     ...
     * TODO: Fix use reflection to call protected method
     */
    protected void adjustGridLayout() {
        ...
        if (fields != null) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                callUnPublicMethod(fieldEditor, "adjustForNumColumns", numColumns);
            }
        }
    }
    ...
    protected void applyFont() {
        if (fields != null) {
            ...
            while (e.hasNext()) {
                ...
                callUnPublicMethod(pe, "applyFont");
            }
        }
    }
     ...
     * 
     * TODO: Fix use of reflection to call un-public methods
     */
    @Override
    public boolean performOk() {
        if (fields != null) {
            ...
            while (e.hasNext()) {
                FieldEditor pe = e.next();
                pe.store();
                callUnPublicMethod(pe, "setPresentsDefaultValue", false);
            }
        }
        return true;
    }
