 ...
 *
 */
public class MessageDialogWithLink extends IconAndMessageDialog {
     ...
     * and lays out a composite and calls <code>createMessageArea</code> and <code>createCustomArea</code> to populate
     * it. Subclasses should
     ...
     * <p>
     * This method waits until the dialog is closed by the end user, and then it returns the dialog's return code. The
     * dialog's return code is either the index of the button the user pressed, or {@link SWT#DEFAULT} if the dialog has
     * been closed by other means.
     * </p>
     *
     ...
     * 
     * @param kind
     * the kind of dialog to open, one of {@link #ERROR}, {@link #INFORMATION}, {@link #QUESTION}, {@link #WARNING},
    ...
    public static boolean open(int kind, Shell parent, String title, String message, int style) {
        MessageDialogWithLink dialog = new MessageDialogWithLink(parent, title, null, message, kind,
