...
public class GlobalVariableValueEdittingSupport extends EditingSupport {
	private MPart parentPart;
	
	public GlobalVariableValueEdittingSupport(ColumnViewer viewer, MPart mpart) {
		super(viewer);
		parentPart = mpart;
	}
	...
	protected void setValue(Object element, Object value) {
		if (element != null && element instanceof GlobalVariableEntity && value != null && value instanceof String) {
			...
			if (!variable.getInitValue().equals(value)) {
				variable.setInitValue((String) value);
