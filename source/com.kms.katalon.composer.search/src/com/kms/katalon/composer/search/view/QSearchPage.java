...
public class QSearchPage extends DialogPage implements ISearchPage {
    ...
    private QSearchQuery createQuery() {
        ...
        fileNamePatterns
                .add("!" + GroovyConstants.CUSTOM_KEYWORD_LIB_FILE_NAME + GroovyConstants.GROOVY_FILE_EXTENSION);
        ...
        QSearchInput input = new QSearchInput(searchText.getText(), chckIsCaseSensitive.getSelection(),
                chckIsRegularExpression.getSelection(), fileNamePatterns.toArray(new String[0]),
    ...
    public void setVisible(boolean visible) {
        if (visible && searchText != null) {
            // Set focus to search field when page is created
            searchText.setFocus();
        }
