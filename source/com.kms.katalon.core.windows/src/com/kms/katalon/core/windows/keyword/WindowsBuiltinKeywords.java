...
public class WindowsBuiltinKeywords extends BuiltinKeywords {
     ...
     *      Absolute path to the Windows application.
     * @param flowControl 
     *      Optional parameter: Controls the execution flow if the step failed. <p>
     *      <ul>
    ...
    public static void startApplication(String appFile, FailureHandling flowControl) throws StepFailedException {
        KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "startApplication", appFile, appFile);
    }

    /**
     * Performs a click action on the {@link WebElement} that is found by using locator value of the given windowsObject.
     * @param windowsObject
    ...
    public static void click(WindowsTestObject windowsObject, FailureHandling flowControl) throws StepFailedException {
        KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "click", windowsObject, flowControl);
    }

    /**
     * Performs a double-click action on the {@link WebElement} that is found by using locator value of the given windowsObject.
     * @param windowsObject
     *      An object that describes locator and locator strategy to find Windows Element.
     * @throws StepFailedException
     ...
     */
    @Keyword(keywordObject = "Element")
    public static void doubleClick(WindowsTestObject windowsObject, FailureHandling flowControl) throws StepFailedException {
        KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "doubleClick", windowsObject, flowControl);
    }

    /**
     * Performs a set text action on the {@link WebElement} that is found by using locator value of the given windowsObject.<br>
     ...
     */
    @Keyword(keywordObject = "Element")
    public static void setText(WindowsTestObject windowsObject, String text, FailureHandling flowControl) throws StepFailedException {
        KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "setText", windowsObject, text, flowControl);
    }
    ...
    public static String getText(WindowsTestObject windowsObject) throws StepFailedException {
        return (String) KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "getText", windowsObject);
    }
     ...
     */
    @Keyword(keywordObject = "Element")
    public static String getText(WindowsTestObject windowsObject, FailureHandling flowControl) throws StepFailedException {
        return (String) KeywordExecutor.executeKeywordForPlatform(KeywordExecutor.PLATFORM_WINDOWS, "getText", windowsObject, flowControl);
    }
