...
public class ReportPart implements EventHandler, IComposerPartEvent {
    ...
    private void createCompositeTestCaseFilter(Composite compositeTestCaseTree) {
        ...
        btnFilterTestCaseSkipped.setText("Skips");
        btnFilterTestCaseSkipped.setImage(ImageConstants.IMG_16_NOT_RUN);
    ...
    private void createSummaryTabControl(final CTabFolder tabFolder) {
        ...
        lblSkipped.setText("Skip");
        setLabelToBeBold(lblSkipped);
        lblSkipped.setForeground(ColorUtil.getIncompleteLogColor());
        ...
        txtTCSkipped.setForeground(ColorUtil.getIncompleteLogColor());
