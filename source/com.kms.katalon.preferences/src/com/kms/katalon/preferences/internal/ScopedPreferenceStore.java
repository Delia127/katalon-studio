 ...
 *
 * Contributors: Eclipse - copy of the implementation coming from jface
 *******************************************************************************/
 ...
 * <p>
 * A ScopedPreferenceStore does the lookup of a preference based on it's search scopes and sets the value of the
...
public class ScopedPreferenceStore extends EventManager implements IPreferenceStore, IPersistentPreferenceStore {
    ...
    private INodeChangeListener getNodeChangeListener() {
        return new IEclipsePreferences.INodeChangeListener() {
            /*
             * (non-Javadoc)
             * @see org.eclipse.core.runtime.preferences.IEclipsePreferences. INodeChangeListener
             * #added(org.eclipse.core.runtime.preferences.IEclipsePreferences .NodeChangeEvent)
             */
             ...
             * (non-Javadoc)
             * @see org.eclipse.core.runtime.preferences.IEclipsePreferences. INodeChangeListener
             * #removed(org.eclipse.core.runtime.preferences.IEclipsePreferences .NodeChangeEvent)
             */
    ...
    private void initializePreferencesListener() {
        if (preferencesListener == null) {
            preferencesListener = new IEclipsePreferences.IPreferenceChangeListener() {
                 ...
                 * #preferenceChange(org.eclipse.core.runtime .preferences.IEclipsePreferences.PreferenceChangeEvent)
                 */
     ...
     * </p>
     * 
     * @param includeDefault <code>true</code> if the default context should be included and <code>false</code>
     * otherwise
    ...
    public void setSearchContexts(IScopeContext[] scopes) {
        ...
        for (int i = 0; i < scopes.length; i++) {
            if (scopes[i].equals(defaultContext)) {
                Assert.isTrue(false, StringConstants.INL_DO_NOT_ADD_DEFAULT_TO_SEARCH_CONTEXTS);
            }
        }
    }
    ...
    /*
     * (non-Javadoc)
     * @see org.eclipse.jface.preference.IPreferenceStore#firePropertyChangeEvent (java.lang.String, java.lang.Object,
     * java.lang.Object)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.eclipse.jface.preference.IPreferenceStore#removePropertyChangeListener
     * (org.eclipse.jface.util.IPropertyChangeListener)
     */
