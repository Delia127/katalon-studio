...
public class CustomPushResultTable {
    ...
    CustomPushResultTable(final Composite parent) {
        this(parent, null);
    }

    CustomPushResultTable(final Composite parent, final IDialogSettings dialogSettings) {
        ...
        treeViewer.setSorter(new ViewerSorter() {
            ...
            public int compare(Viewer viewer, Object e1, Object e2) {
                ...
                if (e1 instanceof CustomRefUpdateElement && e2 instanceof CustomRefUpdateElement) {
                    CustomRefUpdateElement r1 = (CustomRefUpdateElement) e1;
                    CustomRefUpdateElement r2 = (CustomRefUpdateElement) e2;
        ...
        treeViewer.setContentProvider(new CustomRefUpdateContentProvider());
        // detail message
        ...
        treeViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (selected instanceof CustomRefUpdateElement) {
                    text.setText(getResult((CustomRefUpdateElement) selected));
                }
            }
        });
    ...
    private final static class SpellcheckableMessageAreaExtension extends SpellcheckableMessageArea {
        private SpellcheckableMessageAreaExtension(Composite parent, String initialText, boolean readOnly, int styles) {
    ...
    private String getResult(CustomRefUpdateElement element) {
    ...
    void setData(final Repository localDb, final PushOperationResult result) {
        ...
        final List<CustomRefUpdateElement> results = new ArrayList<>();
        ...
        for (URIish uri : result.getURIs()) {
            if (result.isSuccessfulConnection(uri)) {
                for (RemoteRefUpdate update : result.getPushResult(uri).getRemoteUpdates()) {
                    results.add(new CustomRefUpdateElement(result, update, uri, reader, repo));
                }
            }
        }
