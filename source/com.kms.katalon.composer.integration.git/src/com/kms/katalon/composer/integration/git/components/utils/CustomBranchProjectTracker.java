...
public class CustomBranchProjectTracker {
     ...
     * @param repository
     */
    public CustomBranchProjectTracker(final Repository repository) {
    ...
    public String getPreference(final String branch) {
        ...
        return PREFIX + '_' + repository.getDirectory().getAbsolutePath() + '_' + branch;
    }

    /**
     * Snapshot the projects currently associated with the repository
     * <p>
     * The memento returned can be later passed to {@link #save(IMemento)} to persist it
     *
     * @see #save(IMemento)
     ...
     * @return this tracker
     */
    public CustomBranchProjectTracker save(final IMemento memento) {
    ...
    public void restore(final String branch, final IProgressMonitor monitor) {
        ...
        try {
            ...
            Activator.logError("Error restoring branch-project associations", e); //$NON-NLS-1$
