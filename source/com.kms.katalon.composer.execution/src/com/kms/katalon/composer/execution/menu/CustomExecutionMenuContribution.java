...
public class CustomExecutionMenuContribution {
    ...
    public void aboutToShow(List<MMenuElement> menuItems) {
        try {
            ...
            for (String customRunConfigId : RunConfigurationCollector.getInstance().getAllCustomRunConfigurationIds()) {
                MDirectMenuItem customExecutionMenuItem = (MDirectMenuItem) MMenuFactory.INSTANCE.createDirectMenuItem();
                customExecutionMenuItem.setLabel(customRunConfigId);
                customExecutionMenuItem.setElementId(StringConstants.CUSTOM_RUN_CONFIG_ID_PREFIX + customRunConfigId);
