...
public class CustomSourceLookupFacility
        implements IPageListener, IPartListener2, IPropertyChangeListener, IDebugEventSetListener {
     ...
     * @since 3.10
     */
    static class LRU extends HashMap<Object, CustomSourceLookupResult> {
        ...
        public CustomSourceLookupResult remove(Object key) {
            CustomSourceLookupResult oldResult = super.remove(key);
     ...
     */
    private IInstructionPointerPresentation fPresentation = (IInstructionPointerPresentation) DebugUITools
            .newDebugModelPresentation();

    /**
     * Whether to re-use editors when displaying source.
     */
    private boolean fReuseEditor = DebugUIPlugin.getDefault()
            .getPreferenceStore()
    ...
    private IEditorPart openEditor(ISourceLookupResult result, IWorkbenchPage page) {
        ...
        if (fReuseEditor) {
            IEditorReference[] references = page.findEditors(input, id,
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (property.equals(IDebugUIConstants.PREF_REUSE_EDITOR)) {
            fReuseEditor = DebugUIPlugin.getDefault()
                    .getPreferenceStore()
                    .getBoolean(IDebugUIConstants.PREF_REUSE_EDITOR);
        }
    }
    ...
    public class CustomSourceLookupResult extends SourceLookupResult {

        public CustomSourceLookupResult(Object artifact, Object sourceElement, String editorId,
