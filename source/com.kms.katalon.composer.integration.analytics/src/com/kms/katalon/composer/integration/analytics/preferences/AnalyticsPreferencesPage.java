...
public class AnalyticsPreferencesPage extends FieldEditorPreferencePageWithHelp {
    ...
    private void createTestResultGroup() {
        ...
        cbxAttachCaptureVideo.setText(ComposerIntegrationAnalyticsMessageConstants.LBL_TEST_RESULT_ATTACH_CAPTURED_VIDEO);
    ...
    private void fillData() {
        try {
            ...
            if (enableAnalyticsIntegration.getSelection()) {
                teams = getTeams(analyticsSettingStore.getServerEndpoint(), 
                        analyticsSettingStore.getEmail(), 
                        analyticsSettingStore.getPassword(), false);
                ...
                if (teams != null && teams.size() > 0) {
	                ...
	                projects = getProjects(analyticsSettingStore.getServerEndpoint(), 
	                        analyticsSettingStore.getEmail(), 
	                        analyticsSettingStore.getPassword(), team, false);
            ...
            txtPassword.setText(analyticsSettingStore.getPassword());
    ...
    private void updateDataStore() {
        try {
            ...
            analyticsSettingStore.setProject(cbbProjects.getSelectionIndex() != -1 ? projects.get(cbbProjects.getSelectionIndex()) : null);
    ...
    private void addListeners() {
        ...
        btnConnect.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                projects = getProjects(serverUrl, 
                        email, 
                        password, team, false);
                if (projects != null && !projects.isEmpty()) {
                    cbbProjects.setItems(getProjectNames(projects).toArray(new String[projects.size()]));
        ...
        btnCreate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                NewProjectDialog dialog = new NewProjectDialog(btnCreate.getDisplay().getActiveShell(), serverUrl, email, password, team);
    ...
    private List<AnalyticsProject> getProjects(final String serverUrl, final String email,
            final String password,
            final AnalyticsTeam team,
        ...
        try {
            new ProgressMonitorDialog(getShell()).run(true, false, new IRunnableWithProgress() {
                ...
                public void run(IProgressMonitor monitor)
                    ...
                    try {
                        monitor.beginTask(ComposerIntegrationAnalyticsMessageConstants.MSG_DLG_PRG_RETRIEVING_PROJECTS, 2);
                        ...
                        final List<AnalyticsProject> loaded = AnalyticsApiProvider.getProjects(serverUrl, team, tokenInfo.getAccess_token());
    ...
    private List<AnalyticsTeam> getTeams(final String serverUrl, final String email,
            final String password,
            final boolean isUpdateStatus) {
            ...
            new ProgressMonitorDialog(getShell()).run(true, false, new IRunnableWithProgress() {
                ...
                public void run(IProgressMonitor monitor)
                    ...
                    try {
                        ...
                        final List<AnalyticsTeam> loaded = AnalyticsApiProvider.getTeams(serverUrl, tokenInfo.getAccess_token());
                        if (loaded != null && !loaded.isEmpty()) {
                            teams.addAll(loaded);
                        }
                        monitor.worked(1);
