...
public class ComposerIntegrationAnalyticsMessageConstants extends NLS {
    ...
    public static String BTN_NEW_PROJECT;

    public static String BTN_CREATE;

    public static String ERROR_MSG_CREATE_PROJECT;

    public static String MSG_DLG_CREATE_PROJECT_SUCCESSFULLY;

    public static String LBL_SELECT_GROUP;

    public static String LBL_TEST_RESULT_GROUP;

    public static String LBL_TEST_RESULT_AUTO_SUBMIT;

    public static String LBL_TEST_RESULT_ATTACH_SCREENSHOT;
    ...
    public static String MSG_DLG_PRG_CREATING_PROJECTS;
    ...
    private ComposerIntegrationAnalyticsMessageConstants() {
    }
}
