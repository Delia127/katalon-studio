...
public class ImageConstants extends com.kms.katalon.composer.components.impl.constants.ImageConstants {
    ...
    public static final Image IMG_16_DATA_CROSS = ImageManager.getImage(IImageKeys.TEST_DATA_TYPE_MANY_16);

    public static final Image IMG_16_DATA_ONE_ONE = ImageManager.getImage(IImageKeys.TEST_DATA_TYPE_ONE_16);
