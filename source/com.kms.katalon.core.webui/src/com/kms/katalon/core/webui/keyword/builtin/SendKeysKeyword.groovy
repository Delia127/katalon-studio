    ...
    public void sendKeys(TestObject to, String strKeys, FailureHandling flowControl) throws StepFailedException {
        WebUIKeywordMain.runKeyword({
            ...
            try {
                ...
                logger.logInfo(MessageFormat.format(StringConstants.KW_LOG_INFO_SENDING_KEYS_TO_OBJ, [strKeys, to.getObjectId()] as Object[]))
                WebElement webElement = WebUIAbstractKeyword.findWebElement(to)
                webElement.sendKeys(strKeys)
                logger.logPassed(MessageFormat.format(StringConstants.KW_LOG_PASSED_KEYS_SENT_TO_OBJ, [strKeys, to.getObjectId()] as Object[]))
            } finally {
