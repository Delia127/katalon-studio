...
public class WebUiCommonHelper extends KeywordHelper {
     ...
     * currently on. The image will be resized to the size of the web element
     * 
     * @param driver
     ...
     */
    public static String saveWebElementScreenshotAndResize(WebDriver driver, WebElement ele, String name, String path)
            throws IOException {
