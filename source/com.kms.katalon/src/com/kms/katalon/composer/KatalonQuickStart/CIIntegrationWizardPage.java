...
public class CIIntegrationWizardPage extends AbstractWizardPage implements WizardPage{

    public CIIntegrationWizardPage() {
    ...
    public void createStepArea(Composite parent) {
        ...
        Image imageTitleArea = ImageConstants.IMG_INTRO_SCREEN_CI_INTEGRATION;
