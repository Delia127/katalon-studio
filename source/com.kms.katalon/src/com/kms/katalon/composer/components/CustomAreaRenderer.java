...
// Use custom renderer to workaround for bug 332463 (https://bugs.eclipse.org/bugs/show_bug.cgi?id=332463) and for adding ThreeTabsCompositePart.
@SuppressWarnings("restriction")
public class CustomAreaRenderer extends SWTPartRenderer {
	...
	private void synchCTFState(MArea areaModel) {
		...
		int count = 0;
		for (MPartStack stack : stacks) {
			if (stack.isToBeRendered() && areaModel.getChildren().contains(stack))
				count++;
		}
