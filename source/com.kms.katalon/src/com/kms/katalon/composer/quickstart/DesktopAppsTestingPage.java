...
public class DesktopAppsTestingPage extends AbstractWizardPage implements WizardPage {

    public DesktopAppsTestingPage() {

    }

    @Override
    public String getTitle() {
        return "Desktop Apps Testing";
    }
    ...
    public void createStepArea(Composite parent) {
        ...
        Image imageTitleArea = ImageConstants.IMG_INTRO_SCREEN_DESKTOP_APPS_TESTING;
