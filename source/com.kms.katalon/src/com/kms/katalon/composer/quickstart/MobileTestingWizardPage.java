...
public class MobileTestingWizardPage extends AbstractWizardPage implements WizardPage {

    public MobileTestingWizardPage() {
    ...
    public void createStepArea(Composite parent) {
        ...
        Image imageTitleArea = ImageConstants.IMG_INTRO_SCREEN_MOBILE_TESTING;
