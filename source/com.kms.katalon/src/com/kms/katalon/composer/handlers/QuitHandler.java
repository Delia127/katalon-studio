...
public class QuitHandler {
    ...
    public boolean execute(IWorkbench workbench, Shell shell, EPartService partService) {
        ...
        MessageDialogWithToggle confirm = MessageDialogWithToggle.open(MessageDialogWithToggle.CONFIRM, shell,
                ...
                prefs.getBoolean(PreferenceConstants.ProjectPreferenceConstants.RECENT_AUTO_RESTORE), prefs,
                PreferenceConstants.ProjectPreferenceConstants.RECENT_AUTO_RESTORE, SWT.NONE);
        if (confirm.getReturnCode() == Window.OK) {
            if (partService.saveAll(true)) {
                prefs.setValue(PreferenceConstants.ProjectPreferenceConstants.RECENT_AUTO_RESTORE,
