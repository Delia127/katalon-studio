...
public class UpdateEdgeChromiumWebdriverHandler {
    ...
    public void execute(Shell shell) {
        ...
        installationManager.getInstallationDialog().setDialogTitle(MessageFormat.format(StringConstants.DIA_TITLE_UPDATE_WEBDRIVER, "Edge Chromium"));
        ...
        InstallationStep installationStep = new InstallationStep(StringConstants.MSG_UPDATING_WEB_DRIVER) {
            ...
            public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                try {
                    DriverDownloadManager.downloadDriver(WebUIDriverType.EDGE_CHROMIUM_DRIVER, getLogFile(), getErrorLogFile());
        ...
        Trackings.trackUseAutoUpdateEdgeChromiumDriver();
        try {
