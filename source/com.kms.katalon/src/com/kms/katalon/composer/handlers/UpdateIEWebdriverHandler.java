...
public class UpdateIEWebdriverHandler {
    ...
    public void execute(Shell shell) {
        ...
        installationManager.getInstallationDialog().setDialogTitle(MessageFormat.format(StringConstants.DIA_TITLE_UPDATE_WEBDRIVER, "IE"));
        ...
        InstallationStep installHomebrewStep = new InstallationStep(StringConstants.MSG_UPDATING_WEB_DRIVER) {
            ...
            public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
                try {
                    DriverDownloadManager.downloadDriver(WebUIDriverType.IE_DRIVER, getLogFile(), getErrorLogFile());
