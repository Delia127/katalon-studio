...
public class CreateNewTestSuiteParentDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        groupOptions.setText(StringConstants.DIA_TITLE_CREATION_OPTIONS);
    ...
    private void loadInput() {
        ...
        ControlUtils.recursiveSetEnabled(groupOptions, false);
        ...
        display.asyncExec(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    MultiStatusErrorDialog.showErrorDialog(e, StringConstants.DIA_MSG_UNABLE_TO_UPLOAD_TEST_SUITE, e
    ...
    private void initCreationButtons() {
        ControlUtils.recursiveSetEnabled(groupOptions, true);
