...
public class HTMLRawElementTreeContentProvider implements ITreeContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof HTMLRawElement) {
			return ((HTMLRawElement) parentElement).getChildElements().toArray();
		}
		return Collections.emptyList().toArray();
	}
	...
	public Object getParent(Object element) {
		if (element instanceof HTMLRawElement) {
			return ((HTMLRawElement) element).getParentElement();
		}
		return null;
	}
	...
	public boolean hasChildren(Object element) {
		if (element instanceof HTMLRawElement) {
			return ((HTMLRawElement) element).getChildElements().size() > 0;
		}
		return false;
	}
