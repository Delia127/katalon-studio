...
- cd into the Firefox\Object Spy and run the command "cfx xpi"
...
After build completed, update the packed extensions in the <object spy project location>\resources\extensions folder.