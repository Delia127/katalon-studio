...
public class ImportSeleniumIdeHandler {
	...
	private void createTestSuite(TestSuite testSuite) throws Exception {
        ...
        createTestCases(testSuite.getTestCases());
	...
	private void createTestCases(List<TestCase> testCases) throws Exception {
		Object[] selectedObjects = (Object[]) selectionService.getSelection(IdConstants.EXPLORER_PART_ID);
        ...
        if (!testCases.isEmpty()) {
        	for (TestCase testCase : testCases) {
        		...
        		tcController.saveNewTestCase(testCaseEntity);
        	}
        }
	}
