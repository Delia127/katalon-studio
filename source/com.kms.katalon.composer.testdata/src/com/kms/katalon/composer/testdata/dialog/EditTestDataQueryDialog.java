...
public class EditTestDataQueryDialog extends AbstractDialog {

    private Button chkGlobalDBSetting;
    ...
    protected void okPressed() {
        updateChangesToTestData();
        super.okPressed();
    }

    private void updateChangesToTestData() {
        if (!isChanged()) {
            return;
        }
    ...
    private void enableCustomDBConnection(boolean enabled) {
