...
public interface ProxyPreferenceConstants {
    ...
    public static final String AUTH_DISABLE_MOB_BROWSER_PROXY = "proxy.auth.preferences.disableMobRowserProxy";
    ...
    public static final String SYSTEM_DISABLE_MOB_BROWSER_PROXY = "proxy.system.preferences.disableMobRowserProxy";
}
