...
public class NewJavaClassDialog extends CommonAbstractKeywordDialog {
    ...
    public NewJavaClassDialog(Shell parentShell, IPackageFragmentRoot rootPackage, IPackageFragment parentPackage) {
        super(parentShell, null);
        setDialogTitle(StringConstants.DIA_TITLE_KEYWORD);
        setDialogMsg(ComposerKeywordMessageConstants.DIA_MSG_CREATE_JAVA_CLASS);
