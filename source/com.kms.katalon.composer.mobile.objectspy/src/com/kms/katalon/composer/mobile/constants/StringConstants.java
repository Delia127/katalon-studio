...
public class StringConstants extends GlobalStringConstants {
    ...
    // MobileDeviceDialog
    public static final String DIA_DIALOG_TITLE_DEVICE_VIEW = "Device View";

    public static final String DIA_LBL_SCREEN = "Screen";

    // MobileInspectorController
    public static final String DIA_ERROR_MSG_UNABLE_TO_CAPTURE_SCREEN = "Unable to capture screen.";
    ...
    public static final String DIA_TIP_START_APP = "Start";

    public static final String DIA_TIP_CAPTURE_OBJ = "Capture Object";

    public static final String DIA_TIP_ADD = "Add to Object Repository";
    ...
    public static final String DIA_LBL_STATUS_APP_STARTING = "Starting application...";

    public static final String DIA_LBL_STATUS_APP_STARTED = "Application started successful";
