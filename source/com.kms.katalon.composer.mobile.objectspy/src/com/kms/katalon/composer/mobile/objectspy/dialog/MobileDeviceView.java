...
public class MobileDeviceView {
    ...
    public Composite createControls(Composite parent) {
        ...
        lblScreenComposite.setText("DEVICE VIEW");
    ...
    public void highlight(final double x, final double y, final double width, final double height) {
        ...
        List<Rectangle> scaledRects = new ArrayList<Rectangle>();
        scaledRects.add(newHighlightRect);
        internalHighlightRects(scaledRects);
    }
    ...
    public void highlightRects(List<Rectangle> rects) {
        ...
        for (Rectangle rect : rects) {
            Rectangle newHighlightRect = new Rectangle(
                    safeRoundDouble(rect.x * hRatio),
                    safeRoundDouble(rect.y * hRatio),
                    safeRoundDouble(rect.width * hRatio),
                    safeRoundDouble(rect.height * hRatio));
            scaledRects.add(newHighlightRect);
        }
        internalHighlightRects(scaledRects);
    }
