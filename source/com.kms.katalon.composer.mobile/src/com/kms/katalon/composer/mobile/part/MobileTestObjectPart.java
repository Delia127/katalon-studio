...
public class MobileTestObjectPart implements IComposerPart {
    ...
    public void onCreatePart(MPart mpart, Composite parent) {
        this.mpart = mpart;
        entity = (MobileElementEntity) mpart.getObject();
        ...
        public void handleEvent(Event event) {
            ...
            try {
                ...
                if (editingEntity.getIdForDisplay().equals(oldWindowsObjectId)) {
                    entity = (MobileElementEntity) ObjectRepositoryController.getInstance().getWebElementByDisplayPk(newWindowsObjectId);
                    editingEntity = (MobileElementEntity) entity.clone();
    ...
    private void setInput() {
        editingEntity = (MobileElementEntity) entity.clone();
        mpart.setLabel(editingEntity.getName());
        MobileElementEntity.LocatorStrategy selectedLocator = editingEntity.getLocatorStrategy();
        ...
        properties = new ArrayList<>(editingEntity.getWebElementProperties());
    ...
    private void createControls(Composite parent) {
        ...
        tltmAdd.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                NewMobileElementPropertyDialog windowsElementDialog = new NewMobileElementPropertyDialog(getShell());
                if (windowsElementDialog.open() == NewMobileElementPropertyDialog.OK) {
    ...
    @Persist
    public void onSave() {
        MobileElementEntity.LocatorStrategy selectedLocator = MobileElementEntity.LocatorStrategy
        ...
        editingEntity.setWebElementProperties(properties);

        try {
            ObjectRepositoryController.getInstance().updateTestObject(editingEntity);
            entity = editingEntity;
            editingEntity = (MobileElementEntity) editingEntity.clone();
