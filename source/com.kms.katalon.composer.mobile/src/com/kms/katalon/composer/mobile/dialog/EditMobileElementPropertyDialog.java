...
public class EditMobileElementPropertyDialog extends AbstractDialog {
    ...
    public EditMobileElementPropertyDialog(Shell parentShell, WebElementPropertyEntity editingProperty) {
        super(parentShell);
