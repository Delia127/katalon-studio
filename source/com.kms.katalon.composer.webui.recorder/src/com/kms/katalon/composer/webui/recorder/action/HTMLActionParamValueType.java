...
public class HTMLActionParamValueType {
    ...
    public HTMLActionParamValueType clone() {
        HTMLActionParamValueType clonedElement = new HTMLActionParamValueType();
        clonedElement.setEditorProvider(editorProvider);
        Object clonedValue = (value instanceof ASTNodeWrapper) ? ((ASTNodeWrapper) value).clone() : value;
        clonedElement.setValue(clonedValue);
