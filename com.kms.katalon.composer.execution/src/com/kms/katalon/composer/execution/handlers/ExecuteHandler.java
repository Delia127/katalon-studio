...
public class ExecuteHandler {
	...
	// protected void executeTestCase(final TestCaseEntity testCase, final
	// BrowserType browser, final int pageLoadTimeout,
	// final LaunchMode launchMode) throws Exception {
