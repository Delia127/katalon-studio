...
public class IDELauncher extends AbstractLauncher {
	...
	public IDELauncher(IEventBroker eventBroker, Logger systemLogger, LaunchMode launchMode,
	...
	// public void launch(TestSuiteEntity testSuite, BrowserType browserType,
	// int pageLoadTimeout,
