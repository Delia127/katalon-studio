...
public class MailUtil {
	...
	private static final String SUBJECT = "qAutomate Report";
	...
	public static void sendSummaryMail(EmailConfig conf, File csvFile, List<Object[]> suitesSummaryForEmail) throws Exception {
		...
		sbHtml.append("<html>");
		sbHtml.append("<head><title>qAutomate Summary Report</title></head>");
		sbHtml.append("<body>");
	...
	private static StringBuilder buildMailContent(String signature) {
		...
		//Header
		sb.append("<html>\n");
		sb.append("<head><title>qAutomate Summary Report</title></head>\n");
		sb.append("<body>\n");
