...
import com.kms.katalon.composer.testsuite.events.TestSuiteEventConstants;
import com.kms.katalon.composer.testsuite.providers.TestCaseTableViewer;
import com.kms.katalon.entity.link.TestSuiteTestCaseLink;

public class IsRunColumnEditingSupport extends EditingSupport {
    ...
    public IsRunColumnEditingSupport(ColumnViewer viewer, IEventBroker eventBroker) {
        super(viewer);
