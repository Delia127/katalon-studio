...
public class QTestIntegrationReporter implements ReportIntegrationContribution {
	...
	public void uploadTestCaseResult(TestSuiteEntity testSuiteEntity, IntegratedEntity projectIntegratedEntity,
		...
		if (testSuiteIntegratedEntity != null && testCaseIntegratedEntity != null
				&& isSameQTestProject(testCaseEntity, testSuiteEntity)) {
			...
			QTestRun testRun = QTestIntegrationTestSuiteManager.getTestRunByTestSuiteAndTestCaseId(
					selectedQTestSuite, qTestCase.getId());
			...
			if (testRun == null) {
				...
				QTestIntegrationUtil.addNewTestRunToTestSuite(testSuiteEntity, testSuiteIntegratedEntity, selectedQTestSuite, testRun,
						qTestSuiteCollection);
			}			
	 ...
	 */
	private boolean isSameQTestProject(TestCaseEntity testCaseEntity, TestSuiteEntity testSuiteEntity) throws Exception {
		TestCaseRepo testCaseRepo = QTestIntegrationUtil.getTestCaseRepo(testCaseEntity);
