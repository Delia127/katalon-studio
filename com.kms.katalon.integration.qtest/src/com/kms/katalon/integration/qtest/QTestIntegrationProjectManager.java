...
public class QTestIntegrationProjectManager {
	...
	public static List<QTestProject> getAllProject(String token, String serverUrl)
			throws Exception {
	...
	private static List<Project> getAll(String token, String serverUrl)
			throws Exception {
		...
		ProjectServiceClient projectService = new ProjectServiceClient(
				credentials);
