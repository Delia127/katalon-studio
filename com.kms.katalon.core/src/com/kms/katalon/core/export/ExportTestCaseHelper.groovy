...
public class ExportTestCaseHelper {
	...
	private static setSystemProperties(String projectLocation, int pageLoadTimeout, String driverType, String driverLocation, int waitForIEHang, String logFolderLocation) {
		...
		System.setProperty(RunConfiguration.EXECUTED_BROWSER_PROPERTY, getDriverFromString(driverType))
		switch (driverType) {
			case "Chrome":
				System.setProperty(RunConfiguration.CHROME_DRIVER_PATH_PROPERTY,
				driverLocation);
				break;
			case "IE":
				System.setProperty(RunConfiguration.IE_DRIVER_PATH_PROPERTY,
				driverLocation);
				break;
		}
		System.setProperty(RunConfiguration.WAIT_FOR_IE_HANGING_PROPERTY, String.valueOf(waitForIEHang))
	...
	@CompileStatic
	public static getLogFileFromLogFolderLocation(String logFolderLocation) {
