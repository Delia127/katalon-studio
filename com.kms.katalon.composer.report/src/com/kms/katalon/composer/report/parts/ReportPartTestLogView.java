...
public class ReportPartTestLogView {
	...
	private void createCompositeTestLogFilter(Composite compositeTestCaseLogTree) {
		...
		GridLayout gl_compositeTestLogFilter = new GridLayout(5, false);
		gl_compositeTestLogFilter.marginHeight = 0;
		compositeTestLogFilter.setLayout(gl_compositeTestLogFilter);
		...
		GridLayout gl_compositeTestLogSearch = new GridLayout(2, false);
		gl_compositeTestLogSearch.marginWidth = 0;
		gl_compositeTestLogSearch.marginHeight = 0;
		compositeTestLogSearch.setLayout(gl_compositeTestLogSearch);
	...
	public Composite createCompositeTestStepTree(SashForm sashFormDetails) {
		...
		GridLayout gl_compositeTestLogTree = new GridLayout(1, false);
		gl_compositeTestLogTree.marginWidth = 0;
		gl_compositeTestLogTree.marginHeight = 0;
		compositeTestLogTree.setLayout(gl_compositeTestLogTree);
		...
		GridLayout gl_compositeTestLogTreeHeader = new GridLayout(1, false);
		gl_compositeTestLogTreeHeader.marginTop = 5;
		compositeTestLogTreeHeader.setLayout(gl_compositeTestLogTreeHeader);
		...
		GridLayout gl_compositeTestCaseLogTreeDetails = new GridLayout(1, false);
		gl_compositeTestCaseLogTreeDetails.marginWidth = 0;
		gl_compositeTestCaseLogTreeDetails.marginHeight = 0;
		compositeTestCaseLogTreeDetails.setLayout(gl_compositeTestCaseLogTreeDetails);

		CTabFolder tabFolder = new CTabFolder(compositeTestCaseLogTreeDetails, SWT.NONE);
		...
		tltmCollapseAllLogs = new ToolItem(toolbar, SWT.NONE);
		...
		tltmExpandAllLogs = new ToolItem(toolbar, SWT.NONE);
	...
	private void createTestLogTabItem(CTabFolder tabFolder) {
		CTabItem tbtmTestLog = new CTabItem(tabFolder, SWT.NONE);
	...
	private void createTestCaseInformationTabItem(CTabFolder tabFolder) {
		...
		Composite compositeTestCaseInformation = new Composite(tabFolder, SWT.NONE);
	...
	private void createTestCaseIntegrationTabItem(CTabFolder tabFolder) {
		...
		GridLayout gl_compositeTestCaseIntegration = new GridLayout(2, false);
		gl_compositeTestCaseIntegration.horizontalSpacing = 20;
		compositeTestCaseIntegration.setLayout(gl_compositeTestCaseIntegration);
	...
	private void createSelectedTestStepInformationTabItem(CTabFolder tabFolder) {
		...
		GridLayout gl_compositeSTLInformation = new GridLayout(6, false);
		gl_compositeSTLInformation.horizontalSpacing = 15;
		compositeSTLInformation.setLayout(gl_compositeSTLInformation);
