...
public abstract class AbstractReportTestCaseIntegrationView {
	protected ReportEntity reportEntity;
	protected MPart mpart;
	
	public AbstractReportTestCaseIntegrationView(ReportEntity reportEntity) {
	...
	public abstract Image getImage(TestCaseLogRecord testCaseLogRecord);
