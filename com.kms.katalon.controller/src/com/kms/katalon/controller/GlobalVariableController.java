...
public class GlobalVariableController extends EntityController {
	...
	public void updateVariables(List<GlobalVariableEntity> glbVariableEntities, ProjectEntity project)
			throws Exception {
		dataProviderSetting.getGlobalVariableDataProvider().updateVariables(glbVariableEntities,
				project.getLocation());
