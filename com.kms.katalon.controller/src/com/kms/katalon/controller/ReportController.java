...
private static EntityController _instance;
	...
	public String generateReportFolder(TestCaseEntity testCase) throws Exception {
		String testCaseRootLogFolder = dataProviderSetting.getReportDataProvider().getLogDirectory((TestCaseEntity) testCase);
	...
	public ReportEntity getReportEntityByDisplayId(String reportDisplayId, ProjectEntity projectEntity) throws Exception {
	...
	public TestSuiteEntity getTestSuiteByReport(ReportEntity report) throws Exception {
		if (report == null || report.getParentFolder() == null) return null;
