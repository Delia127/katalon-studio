...
class DragAndDropViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let longpress = UILongPressGestureRecognizer(target: self, action: #selector(DragAndDropViewController.longPressGestureRecognized(_:)))
